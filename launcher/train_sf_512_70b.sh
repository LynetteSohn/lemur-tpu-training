...
python -m xtpu.train \
    ...
    --optimizer.adamw_optimizer.lr_warmup_steps=16000 \
    ...
    --train_dataset.multisource_json_dataset.batch_size=64 \
    ...
    --logger.output_dir="gs://.../cxing/models/xtpu-dynamic-json-512-70B-llama2-exp2" \
    ...
    > $HOME/xtpu-dynamic-json-512-70B-llama2-exp2.log 2>&1
