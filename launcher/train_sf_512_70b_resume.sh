...
python -m xtpu.train \
    ...
    --update_llama_config='' \
    --load_dataset_state='gs://.../xtpu-dynamic-json-512-70B-llama2-exp7.3/5de01b28d1f14964ba7915443cd6c985/dataset_270000.pkl' \
    --load_checkpoint='trainstate::gs://.../xtpu-dynamic-json-512-70B-llama2-exp7.3/5de01b28d1f14964ba7915443cd6c985/streaming_train_state_270000' \
    ...
    > $HOME/xtpu-dynamic-json-512-70B-llama2-exp7.4.log 2>&1
