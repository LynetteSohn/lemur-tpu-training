...
eval "$(/opt/miniconda/condabin/conda shell.bash hook)" && conda activate xtpu-0818
#conda activate xtpu
...
python -m xtpu.train \
    ...
    --update_llama_config='' \
    --load_dataset_state='gs://.../xtpu-dynamic-json-256-70B-llama2-exp7/55dbccd3a34b49a7934c0891e0ac9bea/dataset_70000.pkl' \
    --load_checkpoint='trainstate::gs://.../xtpu-dynamic-json-256-70B-llama2-exp7/55dbccd3a34b49a7934c0891e0ac9bea/streaming_train_state_70000' \
    --tokenizer.vocab_file='gs://.../llama-2-70b-tpu/tokenizer.model' \
    ...
    --train_dataset.multisource_json_dataset.path='gs://.../ds_info_v4.json' \
    --train_dataset.multisource_json_dataset.seq_length=4096 \
    --train_dataset.multisource_json_dataset.batch_size=32 \
    ...
    --jax_distributed.num_processes=32 \
    --jax_distributed.process_id=$process_id \
    > $HOME/xtpu-dynamic-json-256-70B-llama2-exp7.1.log 2>&1
