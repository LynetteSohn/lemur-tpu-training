...
python -m xtpu.train \
    ...
    --update_llama_config='' \
    --load_dataset_state='' \
    --load_checkpoint='params::gs://.../cxing/models/llama-33b-tpu/weight.model' \
    ...
    --train_dataset.multisource_json_dataset.path='gs://.../cxing/data/hk-data-v2/ds_info.json' \
    --train_dataset.multisource_json_dataset.seq_length=2048 \
    --train_dataset.multisource_json_dataset.batch_size=256 \
    --train_dataset.multisource_json_dataset.tokenizer_processes=16 \
    --optimizer.adamw_optimizer.bf16_momentum=True \
    --checkpointer.save_optimizer_state=True \
    --logger.online=True \
    --logger.prefix='lemur' \
    --logger.project="lemur-tpu" \
    --logger.output_dir="gs://.../cxing/models/xtpu-dynamic-json-512-33B-exp7" \
    ...
    > $HOME/xtpu-dynamic-json-512-33B-exp7.log 2>&1
