...
python -m xtpu.train \
    ...
    --update_llama_config='' \
    --load_dataset_state='gs://.../cxing/models/xtpu-dynamic-json-1024-70B-llama2-exp2/61ae7eb27beb4560ba55ee0bd2c2882d/dataset_10000.pkl' \
    --load_checkpoint='trainstate::gs://.../cxing/models/xtpu-dynamic-json-1024-70B-llama2-exp2/61ae7eb27beb4560ba55ee0bd2c2882d/streaming_train_state_10000' \
    --tokenizer.vocab_file='gs://.../cxing/models/llama-33b-tpu/tokenizer.model' \
    ...
    --optimizer.adamw_optimizer.lr_decay_steps=315000 \
    ...
    --logger.output_dir="gs://.../cxing/models/xtpu-dynamic-json-1024-70B-llama2-exp2.2" \
    --logger.wandb_dir="$OUTPUT_DIR/wandb" \
    --jax_distributed.initialize_jax_distributed=True \
    --jax_distributed.coordinator_address='' \
    --jax_distributed.num_processes=128 \
    --jax_distributed.process_id=$process_id \
    > $HOME/xtpu-dynamic-json-1024-70B-llama2-exp2.2.log 2>&1
