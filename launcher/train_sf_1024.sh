...
python -m xtpu.train \
    ...
    --update_llama_config='' \
    --load_dataset_state='' \
    --load_checkpoint='params::gs://.../cxing/models/llama-2-70b-tpu/weight.model' \
    ...
    --logger.output_dir="gs://.../cxing/models/xtpu-dynamic-json-1024-70B-llama2-exp2" \
    ...
    > $HOME/xtpu-dynamic-json-1024-70B-llama2-exp2.log 2>&1
